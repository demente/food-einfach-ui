...
<div class="row">
	<div class="col justify-content-end">
		<router-link class="btn btn-primary mb-1" :to="{name:'MealPlanEditableView', params: {id: mealPlan.id}}">Edit</router-link>
...
<!-- column header and tags-->
	<div class="col">
		...
		<DayWeek v-for="day in ['MONDAY','TUESDAY','WEDNESDAY','THURSDAY', 'FRIDAY','SATURDAY','SUNDAY']" :key="day" :recipes="recipesForDay(day)" :dayOfWeek="day"/>
	</div>
	...
	<div class="col">
		...
		<div class="row  mb-2">
			<div class="container">
				<div class="row">
					<div class="col">	
						<h5 class="badge-primary" style="padding: 10px 10px; font-size:.9rem">Nutritional info (average per day)</h5>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					...
					<div class="col text-right">{{convertToGram(nutritionalInformationPerDay.carbohydrates)}} g</div>
				</div>
				<div class="row">
			...
			<div class="col">
				<div class="row">
					<div class="container">
						<div class="row">
							<div class="col">	
								<h5 class="badge-primary" style="padding: 10px 10px; font-size:.9rem">Vitamins (per day)</h5>
							</div>
						</div>
						<ElementRow v-for="vitamin in sortedVitamins" :key="vitamin.name" :element="vitamin"/>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="container">
						<div class="row">
							...
							<ElementRow v-for="mineral in sortedMinerals" :key="mineral.name" :element="mineral"/>
					</div>
				</div>
			</div>
