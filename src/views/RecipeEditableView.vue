...
<div class="row ">
  <div class="col">
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item active">{{recipe.name}} (editing)</li>
	</ol>
  </div>
</div>
<!--end of breadcrumb -->
...
<div class="row">
	...
	<div class="col-4">
		...
		<router-link class="btn btn-primary mb-1" :to="{name:'RecipeView', params: {id: recipe.id}}">Cancel</router-link>
